...
con enrutamiento inteligente, sistema de fallback y soporte para LLM locales (Ollama).
...
if __name__ == "__main__":
    ...
    print("Escribe tu consulta legal. Para salir, escribe 'salir'.")
    print("="*50 + "\n")

    while True:
        try:
            pregunta = input("👉 Haz tu pregunta legal: ").strip()
